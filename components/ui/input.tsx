  ...
  (
    ...
    return (
      <div className={cn("relative flex flex-col", block ? "w-full" : "")}>
        ...
        <div
          className={cn(
            "relative flex items-center hover:border-foreground/50 w-full px-3 py-2 border-foreground/10 shadow shadow-foreground/10 border rounded text-[14px] transition-all",
