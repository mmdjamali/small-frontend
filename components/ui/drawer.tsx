...
>(({ side, className, ...props }, ref) => {
  ...
  return (
    <DialogPrimitives.Content
      ref={ref}
      className={cn(
        "animate-duration-200 animate-ease-linear fixed z-[999] h-full w-full overflow-auto bg-background shadow-md shadow-foreground/20 data-[state=open]:animate-in data-[state=closed]:animate-out	",
        variant[side],
        className,
      )}
      {...props}
