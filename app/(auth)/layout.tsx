  ...
  return (
    <div className="relative block h-fit w-full text-foreground">
      <div className="grid h-full w-full grid-cols-1 place-items-center md:grid-cols-3 lg:grid-cols-2">
        {children}
        <div className="inset-0 top-0 hidden h-screen max-h-screen w-full duration-500 md:sticky md:flex">
          <Image
            className="object-cover duration-1000 animate-in fade-in-0"
            unoptimized
            fill
